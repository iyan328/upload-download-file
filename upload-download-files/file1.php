                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
									...
									<tr class="satu">
										...
										<td><a href="logbook1.php?kode=<?php echo $data1['nim']?>"> Lihat </a> </td>
										<td><a href="jobdesk1.php?kode=<?php echo $data1['nim']?>"> Lihat </a> </td>
										<td><a href="absensi1.php?kode=<?php echo $data1['nim']?>"> Lihat </a> </td>
									</tr>
									<?php
										$no++;}
									?>
