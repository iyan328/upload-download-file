                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Surat Pengantar <small><?php echo $perusahaan?></small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
									<?php
										include "koneksi.php";
										$sql = "SELECT * FROM sp where perusahaan = '$perusahaan' and s_pudir = 'Disetujui' group by surat";
										$kueri = mysql_query($sql);
										$no=1;
									...
									?>
											...
											<!--<td><a href="../perusahaan/approve.php?kode=<?php echo $data['perusahaan']?>">Approve</a></td>
											<td><a href="../perusahaan/tolak.php?kode=<?php echo $data['perusahaan']?>">Tolak</a></td> -->
											</tr>
									<?php
											$no++;}
									?>
